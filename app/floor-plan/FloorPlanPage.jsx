      ...
      <main className="w-full bg-white px-4 md:px-0">
        ...
        <div className="max-w-5xl mx-auto py-10">
          ...
          <div className="space-y-6 mt-5 text-gray-800">
            ...
            <p>
              The apartment floor plans at <a href="https://www.sattvaaangane.co/"><b>Sattva Aangane</b></a> are designed by
            ...
            <p>
              Sattva Aangane Bangalore offers the following apartment floor plan
              options:
            </p>
            ...
            <p>
              Sattva Aangane is currently a new launch residential project in
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Sattva Aangane 3 BHK Apartment Floor Plan
            </h3>
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Sattva Aangane 4 BHK Apartment Floor Plan
            </h3>
            ...
            <p>
              The apartment layouts at Sattva Aangane are designed with
            ...
            <p>By studying the Sattva Aangane floor plans, buyers can:</p>
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Sattva Aangane Floor Plan Features
            </h3>
            ...
            <div className="space-y-6 mt-6">
              ...
              <div>
                <h3 className="text-xl font-semibold">
                  3. What is the total land area of the Sattva Aangane project?
                </h3>
                <p>
              ...
              <div>
                <h3 className="text-xl font-semibold">
                  4. What is the starting price of apartments at Sattva Aangane?
                </h3>
                <p>
              ...
              <div>
                <h3 className="text-xl font-semibold">
                  6. What are the main features of the Sattva Aangane floor plan
                  layouts?
                </h3>
                <p>
                  The floor plans at Sattva Aangane are designed with several
              ...
              <div>
                <h3 className="text-xl font-semibold">
                  7. Is Sattva Aangane a new launch project?
                </h3>
                <p>
                  Yes, Sattva Aangane is a newly launched residential project
              ...
              <div>
                <h3 className="text-xl font-semibold">
                  8. Why is the Sattva Aangane floor plan ideal for modern
                  families?
                </h3>
                <p>
                  The Sattva Aangane apartment layouts are designed to offer a
