      ...
      <main className="w-full bg-white px-4 md:px-0">
        ...
        <div className="max-w-5xl mx-auto py-10">
         ...
         <div className="space-y-6 text-gray-800 mt-5">
            ...
            <p>
              <a href="https://www.sattvaaangane.co/">Sattva Aangane</a> offers an opportunity for both <b>homebuyers and real
            ...
            <div className="flex justify-center items-center">
                ...
                alt="Sattva Aangane Apartment Price" />
            </div>
            <p>
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Price Advantages of Sattva Aangane
            </h3>

            <p>
              One of the key highlights of the <b>Sattva Aangane pricing structure</b>
            ...
            <p>
              Sattva Aangane offers flexible payment plans that make it easier
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Why Invest in Sattva Aangane
            </h3>

            <p>
              The <b>Sattva Aangane apartments</b> provide an excellent opportunity for
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Strategic location on <a href="https://www.sattvaaangane.co/location"><b>Old Madras Main Road</b></a></li>
            ...
            <h3 className="text-2xl font-semibold mt-10">
              Sattva Aangane Price Highlights
            </h3>
            ...
            <p>
              The Sattva Aangane price list makes it a desirable residential
